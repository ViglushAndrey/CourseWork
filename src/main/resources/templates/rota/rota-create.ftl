...
<body>
<header><h1 align="center">Create new Rota</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    ...
    <form name="Rota" action="" method="POST">
      ...
      <h3>Serguants:<@spring.formSingleSelect "form.officers" officers "" /></h3>
      ...
      <h3>Department:<@spring.formSingleSelect "form.vzvods" vzvods "" /></h3>
