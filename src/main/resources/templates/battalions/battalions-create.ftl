...
<body>
<header><h1 align="center">Create new Battalion</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    ...
    <form name="Battalion" action="" method="POST">
      ...
      <h3>Officers:<@spring.formSingleSelect "form.officers" officers "" /></h3>
      ...
      <h3>Brigade:<@spring.formSingleSelect "form.brigade" brigade "" /></h3>
