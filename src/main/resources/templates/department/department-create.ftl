...
<body>
<header><h1 align="center">Create new Departament</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    ...
    <form name="Departament" action="" method="POST">
      ...
      <h3>Ordinarys:<@spring.formSingleSelect "form.ordinarys" ordinarys "" /></h3>
      ...
      <h3>TransportEquipment:<@spring.formSingleSelect "form.transportEquipment" transportEq "" /></h3>
      <h3>MilitaryEquipment:<@spring.formSingleSelect "form.militaryEquipment" militaryEq "" /></h3>
