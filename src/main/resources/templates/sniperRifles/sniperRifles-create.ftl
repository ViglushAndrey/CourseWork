...
<head>
  <meta charset="UTF-8">
  <title>Create SniperRifles</title>
...
<body>
<header><h1 align="center">Create new SniperRifles</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add SniperRifles</h3></legend>
    <form name="SniperRifles" action="" method="POST">
...
<a href="/ui/SniperRifles/get/all" class="fa fa-reply"></a>
</body>
</html>