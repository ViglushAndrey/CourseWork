...
<body>
<header><h1 align="center">Create new BTR</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add BTR</h3></legend>
    <form name="BTR" action="" method="POST">
      <h3>Name:<@spring.formInput "form.name" "" "text" /></h3>
      <h3>Personnel:<@spring.formInput "form.personnel" "" "text" /></h3>
      <h3>Armament:<@spring.formInput "form.armament" "" "text" /></h3>
...
<a href="/ui/BTR/get/all" class="fa fa-reply"></a>
</body>
</html>