...
<body>
<header><h1 align="center">Create new Pistols</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add Pistols</h3></legend>
    <form name="pistols" action="" method="POST">
...
<a href="/ui/Pistols/get/all" class="fa fa-reply"></a>
</body>
</html>