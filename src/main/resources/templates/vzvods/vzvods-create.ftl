...
<body>
<header><h1 align="center">Create new Vzvods</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    ...
    <form name="Vzvods" action="" method="POST">
      ...
      <h3>Serguants:<@spring.formSingleSelect "form.serguants" serguants "" /></h3>
      ...
      <h3>Department:<@spring.formSingleSelect "form.department" department "" /></h3>
