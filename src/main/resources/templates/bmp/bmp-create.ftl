...
<body>
<header><h1 align="center">Create new BMP</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add BMP</h3></legend>
    <form name="BMP" action="" method="POST">
...
<a href="/ui/BMP/get/all" class="fa fa-reply"></a>
</body>
</html>