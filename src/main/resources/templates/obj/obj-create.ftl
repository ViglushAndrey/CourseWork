...
<body>
<header><h1 align="center">Create new Obj</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add Obj</h3></legend>
    <form name="obj" action="" method="POST">
      <h3>TypesOfBuildings:<@spring.formInput "form.typesOfBuildings" "" "text" /></h3>

      <input type="submit" value="Create" class="stilisation">
    </form>
  </fieldset>
</div>
<a href="/ui/Obj/get/all" class="fa fa-reply"></a>
</body>
</html>