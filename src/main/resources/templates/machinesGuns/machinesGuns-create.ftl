...
<head>
  <meta charset="UTF-8">
  <title>Create MachinesGuns</title>
...
<body>
<header><h1 align="center">Create new MachinesGuns</h1></header>
<hr class="h-color">
<div style="margin-top: 100px">
  <fieldset style=" margin-left: auto; margin-right: auto">
    <legend style="text-align: center;"><h3>Add MachinesGuns</h3></legend>
    <form name="MachinesGuns" action="" method="POST">
...
<a href="/ui/MachinesGuns/get/all" class="fa fa-reply"></a>
</body>
</html>