...
public class RotaForm {
    ...
    public RotaForm(String id, String name, String personnel, String vzvods, String armament, String officers, String obj, String permanentDislocation, String temporaryDislocation) {
        this.id = id;
        this.name = name;
    ...
    public String getVzvods() {
        return vzvods;
    }

    public void setVzvods(String vzvods) {
        this.vzvods = vzvods;
    }
